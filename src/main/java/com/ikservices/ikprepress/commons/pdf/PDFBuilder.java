package com.ikservices.ikprepress.commons.pdf;
...
public abstract class PDFBuilder {
    ...
    protected final static String PDF_GENERATION_ERROR = "PDF generation error.";
    ...
    protected PDFBuilder(String pdfName) {
